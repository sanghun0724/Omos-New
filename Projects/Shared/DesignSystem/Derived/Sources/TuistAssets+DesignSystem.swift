...
public enum DesignSystemAsset {
  ...
  public enum Colors {
    ...
    public static let color6 = DesignSystemColors(name: "Color 6")
    public static let color7 = DesignSystemColors(name: "Color 7")
    ...
    public static let mainOrange = DesignSystemColors(name: "mainOrange")
  }
  public enum Common {
